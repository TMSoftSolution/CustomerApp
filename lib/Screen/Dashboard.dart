...
class _HomePageState extends State<Dashboard> with TickerProviderStateMixin {
  ...
  AppBar _getAppBar() {
    ...
    return AppBar(
      ...
      title: _selBottom == 0
          ? Image.asset("assets/images/headingpic.png",)
          : Text(
              title!,
              style: TextStyle(
      ...
      actions: <Widget>[
        ...
        IconButton(
          icon: SvgPicture.asset(imagePath + "desel_notification.svg", color: Color(0xffFFC300),),
          onPressed: () {
            CUR_USERID != null
                ? Navigator.push(
                    context,
        ...
        IconButton(
          ...
          icon: SvgPicture.asset(imagePath + "desel_fav.svg", color: Color(0xffFFC300),),
          onPressed: () {
            CUR_USERID != null
                ? Navigator.push(
                    context,
        ...
        child: Container(
          ...
          child: TabBar(
            ...
            tabs: [
              Tab(
                icon: _selBottom == 0
                    ? SvgPicture.asset(imagePath + "sel_home.svg", color: Color(0xffFFC300),)
                    : SvgPicture.asset(imagePath + "desel_home.svg", color: Color(0xffFFC300),),
                text:
                    _selBottom == 0 ? getTranslated(context, 'HOME_LBL') : null,
              ),
              Tab(
                icon: _selBottom == 1
                    ? SvgPicture.asset(imagePath + "category01.svg", color: Color(0xffFFC300),)
                    : SvgPicture.asset(imagePath + "category.svg", color: Color(0xffFFC300),),
                text:
                    _selBottom == 1 ? getTranslated(context, 'category') : null,
              ),
              Tab(
                icon: _selBottom == 2
                    ? SvgPicture.asset(imagePath + "sale02.svg", color: Color(0xffFFC300),)
                    : SvgPicture.asset(imagePath + "sale.svg", color: Color(0xffFFC300),),
                  ...
                  builder: (context, data, child) {
                    return Stack(
                      children: [
                        Center(
                          child: _selBottom == 3
                              ? SvgPicture.asset(imagePath + "cart01.svg", color: Color(0xffFFC300),)
                              : SvgPicture.asset(imagePath + "cart.svg", color: Color(0xffFFC300),),
                        ),
              ...
              Tab(
                icon: _selBottom == 4
                    ? SvgPicture.asset(imagePath + "profile01.svg", color: Color(0xffFFC300),)
                    : SvgPicture.asset(imagePath + "profile.svg", color: Color(0xffFFC300),),
                text:
