...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xfff5bd1f);
  ...
  static const Color grad1Color = Color(0xfff5bd1f);
  static const Color grad2Color = Color(0xffFFC300);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfff5bd1f);
